...
RAINBIRD_CONTROLLER = "controller2"
DATA_RAINBIRD = "rainbird2"
DOMAIN = "rainbird2"

SENSOR_TYPE_RAINDELAY = "raindelay2"
SENSOR_TYPE_RAINSENSOR = "rainsensor2"
# sensor_type [ description, unit, icon ]
SENSOR_TYPES = {
    SENSOR_TYPE_RAINSENSOR: ["Rainsensor2", None, "mdi:water"],
    SENSOR_TYPE_RAINDELAY: ["Raindelay2", None, "mdi:water-off"],
}
